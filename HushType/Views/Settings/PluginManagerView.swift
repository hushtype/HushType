...
struct PluginManagerView: View {
        ...
        Form {
            ...
            Section {
                VStack(alignment: .leading, spacing: 8) {
                    Text("Extend HushType with custom plugins. Place .bundle files in ~/Library/Application Support/HushType/Plugins/ to install them.")
                        .font(.callout)
                    ...
                    HStack(spacing: 12) {
                        ...
                        .accessibilityHint("Reveals the ~/Library/Application Support/HushType/Plugins directory in Finder")
                    }
                }
                .padding(.vertical, 4)
            } header: {
    ...
    private func openPluginsFolder() {
        ...
        let pluginsURL = appSupport.appendingPathComponent("HushType/Plugins")
    ...
    private func togglePlugin(plugin: any HushTypePlugin, activate: Bool) {
        do {
            if activate {
    ...
    private func removePlugin(plugin: any HushTypePlugin) {
        do {
