...
extension ModelInfo {
    static let defaultModels: [ModelInfo] = [
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/ggerganov/whisper.cpp/resolve/main/ggml-tiny.en.bin"]
        ),
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/ggerganov/whisper.cpp/resolve/main/ggml-base.en.bin"]
        ),
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/ggerganov/whisper.cpp/resolve/main/ggml-small.en.bin"]
        ),
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/ggerganov/whisper.cpp/resolve/main/ggml-medium.en.bin"]
        ),
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/ggerganov/whisper.cpp/resolve/main/ggml-large-v3-turbo.bin"]
        ),
        ...
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/Qwen/Qwen2.5-0.5B-Instruct-GGUF/resolve/main/qwen2.5-0.5b-instruct-q4_k_m.gguf"]
        ),
        ModelInfo(
        ...
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/bartowski/Llama-3.2-1B-Instruct-GGUF/resolve/main/Llama-3.2-1B-Instruct-Q4_K_M.gguf"]
        ),
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/bartowski/google_gemma-3-1b-it-GGUF/resolve/main/gemma-3-1b-it-Q4_K_M.gguf"]
        ),
        ModelInfo(
            ...
            mirrorURLs: ["https://hf-mirror.com/bartowski/microsoft_Phi-4-mini-instruct-GGUF/resolve/main/microsoft_Phi-4-mini-instruct-Q4_K_M.gguf"]
        ),
    ]
}
